...
try {
    function openPurposeModal() {
        const purposeModal = document.querySelector('.purposetag .btnmodal');
        ...
        purposeModal.addEventListener('click', (e) => {
            ...
            if (openPurposeModal.classList.contains('active')) {
                refresh('purposemodal', 'open');
                document.body.classList.toggle('modal-open')
            }
            else refresh('purposemodal', 'closed');
        });
    };
    function closeModal() {
...
function loadmorecontent() {
    try {
        const content = document.querySelectorAll('.webinformation .webinfo .weblink');
